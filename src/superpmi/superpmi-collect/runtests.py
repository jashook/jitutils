...
if __name__ == "__main__":
   ...
   if g_is_windows:
      ...
      # Expect us to be in the coreclr/test directory
      coreclr_bin = os.path.join("..", "bin")
      ...
      args = ["sh", "runtest.sh", test_root_dir, test_native_bin_dir, coreclr_bin_dir, mscorlib_dir, corefx_bin_dir, corefx_native_bin_dir]
